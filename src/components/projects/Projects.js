...
export default class Projects extends Component {
			...
			projects: [
				{
					...
					small: "Bettering the lives or Parkinson's patients by assisting them in their daily lives.",
					description:
		...
		return this.state.projects.map((project, i) => {
			...
			return (
				<div key={i} className={`Project ${left ? "left" : "right"}`}>
					<div className="img">
						<img src={project.image} title={project.title} alt={`${project.title} image`} />
	...
	render() {
		return <div className="projects-holder container">{this.renderProjects()}</div>;
	}
}
