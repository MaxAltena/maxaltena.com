...
const Terms = () => {
  return (
    <div>
      ...
      <p>Last updated: 1 January 2019</p>

      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the https://maxaltena.com/ website (the
        "Service") operated by Max Altena ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        ...
        are not owned or controlled by Max Altena.
      </p>
      <p>
        Max Altena has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that Max Altena shall not be
