      ...
      <div className="container row">
        <div className="col s12 m10 offset-m1 l8 offset-l2">
          <p className="section">
            ...
            <Link to="/">https://maxaltena.com/</Link> website (the "Service")
            operated by Max Altena ("us", "we", or "our"). Your access to and
          ...
          <h2 className="hind bold">Links</h2>
          <p className="section">
            Our Service may contain links to third-party web sites or services
            that are not owned or controlled by Max Altena. Max Altena has no
            control over, and assumes no responsibility for, the content,
            privacy policies, or practices of any third party web sites or
            services. You further acknowledge and agree that Max Altena shall
          ...
          <h2 className="hind bold">Governing Law</h2>
          <p className="section">
            These Terms shall be governed and construed in accordance with the
            laws of Netherlands, without regard to its conflict of law
          ...
          <h2 className="hind bold">Changes</h2>
          <p className="section">
