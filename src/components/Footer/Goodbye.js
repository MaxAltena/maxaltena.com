...
const Goodbye = () => {
  return (
    <div className="Goodbye">
      <div className="row">
        <div className="section col m12 l6 hide-on-small-only">
        ...
        <div className="section col s6 offset-s3 hide-on-med-and-up">
          <p className="lowercase">Sitemap</p>
          <div className="row">
        ...
        <div className="section col s6 offset-s3 m6 l3">
