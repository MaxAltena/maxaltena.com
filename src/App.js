...
import LamecoDashoard from "./components/pages/project/LamecoDashboard";
import Resume from "./components/pages/project/Resume";
import Time from "./components/pages/project/Time";
